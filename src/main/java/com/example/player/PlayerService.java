...
public Player updatePlayer(Player player,int playerId){
    ...
    if(player.getPlayerName() != null)  existingPlayer.setPlayerName(player.getPlayerName());
    if(player.getRole() != null)  existingPlayer.setRole(player.getRole());
    if(player.getJerseyNumber() != 0)  existingPlayer.setJerseyNumber(player.getJerseyNumber());
